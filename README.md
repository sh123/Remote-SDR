# Remote-SDR
Slightly modified version of F1ATB Remote-SDR adopted for manual installation on RPI4 64 bit usage and disabled GPIO controls.
...
sudo systemctl start remsdr.service
```
## Release history
