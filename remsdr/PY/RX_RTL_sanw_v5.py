...
# Title: RTL-SDR SSB AM NBFN WBFM  Receiver V5- F1ATB - APRIL 2022
# Author: F1ATB - BUHART
# Copyright: GNU General Public Licence v3.0
# Description: RX for RTL-SDR
...
class RX_RTL_sanw_v5(gr.top_block):

    def __init__(self, SampRate=2048000, device=''):
        gr.top_block.__init__(self, "RTL-SDR SSB AM NBFN WBFM  Receiver V5- F1ATB - APRIL 2022", catch_exceptions=True)
        ...
        self.soapy_rtlsdr_source_0.set_gain_mode(0, G1)
        self.soapy_rtlsdr_source_0.set_frequency(0, Fsdr)
        self.soapy_rtlsdr_source_0.set_frequency_correction(0, 0)
        self.soapy_rtlsdr_source_0.set_gain(0, 'TUNER', G2)
    ...
    def set_G2(self, G2):
        self.G2 = G2
        self.soapy_rtlsdr_source_0.set_gain(0, 'TUNER', self.G2)
    ...
    def set_G1(self, G1):
        self.G1 = G1
        self.soapy_rtlsdr_source_0.set_gain_mode(0, self.G1)
    ...
    def set_Fsdr(self, Fsdr):
        self.Fsdr = Fsdr
        self.soapy_rtlsdr_source_0.set_frequency(0, self.Fsdr)
...
def argument_parser():
    ...
    parser.add_argument(
        "--SampRate", dest="SampRate", type=eng_float, default=eng_notation.num_to_str(float(2048000)),
...
def main(top_block_cls=RX_RTL_sanw_v5, options=None):
    if options is None:
