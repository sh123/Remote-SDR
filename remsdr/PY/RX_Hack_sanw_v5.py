...
# Title: HackRF SSB AM NBFN WBFM  Receiver V5- F1ATB - APRIL 2022
# Author: F1ATB - BUHART
# Copyright: GNU General Public Licence v3.0
# Description: RX for HACK RF
...
class RX_Hack_sanw_v5(gr.top_block):

    def __init__(self, SampRate=2000000, device=''):
        gr.top_block.__init__(self, "HackRF SSB AM NBFN WBFM  Receiver V5- F1ATB - APRIL 2022", catch_exceptions=True)
        ...
        self.soapy_hackrf_source_0 = soapy.source(dev, "fc32", 1, device,
                                  stream_args, tune_args, settings)
        self.soapy_hackrf_source_0.set_sample_rate(0, samp_rate)
        self.soapy_hackrf_source_0.set_bandwidth(0, 0)
        self.soapy_hackrf_source_0.set_frequency(0, Fsdr)
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', G1)
        self.soapy_hackrf_source_0.set_gain(0, 'LNA', min(max(G2, 0.0), 40.0))
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(G3, 0.0), 62.0))
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.dc_blocker_xx_0, 0))
    ...
    def set_G3(self, G3):
        self.G3 = G3
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(self.G3, 0.0), 62.0))
    ...
    def set_G2(self, G2):
        self.G2 = G2
        self.soapy_hackrf_source_0.set_gain(0, 'LNA', min(max(self.G2, 0.0), 40.0))
    ...
    def set_G1(self, G1):
        self.G1 = G1
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', self.G1)
    ...
    def set_Fsdr(self, Fsdr):
        self.Fsdr = Fsdr
        self.soapy_hackrf_source_0.set_frequency(0, self.Fsdr)
...
def argument_parser():
    ...
    parser.add_argument(
        "--SampRate", dest="SampRate", type=eng_float, default=eng_notation.num_to_str(float(2000000)),
...
def main(top_block_cls=RX_Hack_sanw_v5, options=None):
    if options is None:
