...
class TX_Hack_ssbnbfm_v5(gr.top_block):
    ...
    def __init__(self, SampRate=2000000, device=''):
        ...
        self.soapy_hackrf_sink_0 = soapy.sink(dev, "fc32", 1, device,
                                  stream_args, tune_args, settings)
        self.soapy_hackrf_sink_0.set_sample_rate(0, samp_rate)
        self.soapy_hackrf_sink_0.set_bandwidth(0, 0)
        self.soapy_hackrf_sink_0.set_frequency(0, Fsdr)
        self.soapy_hackrf_sink_0.set_gain(0, 'AMP', G1)
        self.soapy_hackrf_sink_0.set_gain(0, 'VGA', min(max(G2, 0.0), 47.0))
    ...
    def set_G2(self, G2):
        self.G2 = G2
        self.soapy_hackrf_sink_0.set_gain(0, 'VGA', min(max(self.G2, 0.0), 47.0))
    ...
    def set_G1(self, G1):
        self.G1 = G1
        self.soapy_hackrf_sink_0.set_gain(0, 'AMP', self.G1)
    ...
    def set_Fsdr(self, Fsdr):
        self.Fsdr = Fsdr
        self.soapy_hackrf_sink_0.set_frequency(0, self.Fsdr)
...
def main(top_block_cls=TX_Hack_ssbnbfm_v5, options=None):
    if options is None:
