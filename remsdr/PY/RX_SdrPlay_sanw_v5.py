...
# Title: SdrPlay SSB AM NBFN WBFM  Receiver V5- F1ATB - APRIL 2022
# Author: F1ATB - BUHART
# Copyright: GNU General Public Licence v3.0
# Description: RX for SDR-PLAY RSP1, RSP1A
...
class RX_SdrPlay_sanw_v5(gr.top_block):

    def __init__(self, SampRate=3000000, device=''):
        gr.top_block.__init__(self, "SdrPlay SSB AM NBFN WBFM  Receiver V5- F1ATB - APRIL 2022", catch_exceptions=True)
        ...
        self.soapy_sdrplay_source_0.set_gain_mode(0, G1)
        self.soapy_sdrplay_source_0.set_frequency(0, Fsdr)
        self.soapy_sdrplay_source_0.set_frequency_correction(0, 0)
        self.soapy_sdrplay_source_0.set_gain(0, min(max(-G2, 0.0), 47.0))
        ...
        self.connect((self.soapy_sdrplay_source_0, 0), (self.dc_blocker_xx_0, 0))
    ...
    def set_G2(self, G2):
        self.G2 = G2
        self.soapy_sdrplay_source_0.set_gain(0, min(max(-self.G2, 0.0), 47.0))
    ...
    def set_G1(self, G1):
        self.G1 = G1
        self.soapy_sdrplay_source_0.set_gain_mode(0, self.G1)
    ...
    def set_Fsdr(self, Fsdr):
        self.Fsdr = Fsdr
        self.soapy_sdrplay_source_0.set_frequency(0, self.Fsdr)
...
def argument_parser():
    ...
    parser.add_argument(
        "--SampRate", dest="SampRate", type=eng_float, default=eng_notation.num_to_str(float(3000000)),
...
def main(top_block_cls=RX_SdrPlay_sanw_v5, options=None):
    if options is None:
